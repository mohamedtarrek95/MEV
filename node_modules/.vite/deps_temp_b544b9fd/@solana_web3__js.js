...
var import_dist, import_dist2, import_dist3, buffer, base64Js, lookup, revLookup, Arr, code, i, len, ieee754, Buffer2, Blob, BlobOptions, Buffer$1, File, FileOptions, INSPECT_MAX_BYTES, SlowBuffer, TranscodeEncoding, atob, btoa2, constants, isAscii, isUtf8, kMaxLength, kStringMaxLength, resolveObjectURL, transcode;
var init_dist = __esm({
  "node_modules/vite-plugin-node-polyfills/shims/buffer/dist/index.js"() {
...
var PublicKey = class _PublicKey2 extends Struct2 {
  ...
  static async createWithSeed(fromPublicKey, seed, programId) {
    const buffer2 = Buffer$1.concat([fromPublicKey.toBuffer(), Buffer$1.from(seed), programId.toBuffer()]);
    const publicKeyBytes = sha2562(buffer2);
  ...
  static createProgramAddressSync(seeds, programId) {
    let buffer2 = Buffer$1.alloc(0);
    seeds.forEach(function(seed) {
      if (seed.length > MAX_SEED_LENGTH) {
        throw new TypeError(`Max seed length exceeded`);
      }
      buffer2 = Buffer$1.concat([buffer2, toBuffer(seed)]);
    });
    buffer2 = Buffer$1.concat([buffer2, programId.toBuffer(), Buffer$1.from("ProgramDerivedAddress")]);
    const publicKeyBytes = sha2562(buffer2);
